...
console.log('[worker] liblouis initialized');
console.log('[worker] Data path:', liblouis.getDataPath());
console.log('[worker] TABLE_URL:', liblouisBuild.TABLE_URL);
console.log('[worker] FS lookup function:', typeof liblouisBuild.FS.lookup);
